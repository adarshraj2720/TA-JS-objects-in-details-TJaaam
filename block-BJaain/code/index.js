...
myObject.someMethod(); //Value Of This// point to the myObject
...
// Output
obj.getThis();// global window

// Output
obj.getThis.call(a); //global window

// Output
obj.getThis2();// point the object

// Output
obj.getThis2.call(a);// point a obj

// Output
obj.getThis3();// global window

// Output
obj.getThis4();// point the function object
...
let object = {
  ...
  double: function () {
    ...
    return this.data.map(function (item) {
      console.log(this); // Output ???// point to global window
      return item * 2;
    });
  },
  doubleArrow: function () {
    ...
    return this.dataDouble.map((item) => {
      console.log(this); // Output ???// point to the object
      return item * 2;
    });
  },
};
